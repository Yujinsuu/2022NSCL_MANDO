...
if __name__ == "__main__":
	...
	ind = 10
	target_speed = 10.0 / 3.6  # km/h -> m/s
	basic_speed = target_speed
	accel_speed = 15.0 / 3.6
	...
	while not rospy.is_shutdown():
		...
		next_wp = next_waypoint(state.x,state.y, mapx, mapy)

		if next_wp > 250 and next_wp < 400: 
		...
		if next_wp > 0 and next_wp <20: path_flag.data = 1
		elif next_wp > 60 and next_wp < 80: path_flag.data = 2
		elif next_wp > 150 and next_wp <160: path_flag.data = 3
		else: path_flag.data = 0
