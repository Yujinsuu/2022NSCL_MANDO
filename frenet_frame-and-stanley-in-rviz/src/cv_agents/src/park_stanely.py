...
rn_id[5] = { 'park': [ i for i in range(5)] }  # ego }
...
def get_ros_msg(x, y, yaw, v, steer, id):
...
obj_msg = Object(x=962719.889823, y=1959032.72744, yaw=4.45, v=1, L=1.400, W=0.72 ) # 주차미션
obs_info = [ ]
...
if __name__ == "__main__":
	...
	with open(path_map + "/src/parking_long.pkl", "rb") as f:
		nodes = pickle.load(f)

	node_wp_num=[]
	node_wp_num=[0,63,76,122,130, 200]
